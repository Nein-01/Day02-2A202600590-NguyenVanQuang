...
Candidate problem |	Người gặp vấn đề
Lượng kiến thức nhiều được nén lại trong thời gian ngắn gây khó tiếp cận |	Học viên, giảng viên
Số TA hỗ trợ lớp quá ít so với số học viên trong 1 lớp |	TA, học viên
Một số lỗi kỹ thuật trong ứng dụng chung khiến cả TA và học viên đều khó khăn |	TA, học viên
Quên deadline giữa nhiều môn |	Học viên
Tìm lại tài liệu/file cũ |	Học viên, nghiên cứ sinh, người đi làm
Đọc tài liệu dài để tìm ý chính |	Học viên, nghiên cứ sinh, người đi làm
Viết status update tuần cho nhóm dự án bằng cách lấy số liệu và note từ Google Docs, Slack, Figma rồi tổng hợp vào Google Slides |	Người đi làm
Tìm lại quyết định / thông tin cũ trong Discord và Google Drive khi chuẩn bị nộp báo cáo nhóm |	Người đi làm
Chuẩn bị nộp bài lab khi không rõ các mục cần ghi, so khớp với rubic |	Người đi làm, học viên
QA/QC Chất Lượng OCR Tài Liệu Cũ/Nát |	
Đánh Giá Hiệu Suất Và Tính Lương CTV Theo Giờ |	
Tự Động Phát Hiện Lỗi Chất Lượng Ảnh Scan Tại Chỗ	|
